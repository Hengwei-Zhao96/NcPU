...
class PUExtraTrees:
    def __init__(self, n_estimators=100, risk_estimator="nnPU", loss="quadratic", max_depth=None, min_samples_leaf=1, max_features="sqrt", max_candidates=1, n_jobs=1):
        """
    ...
    def predict(self, X):
        ...
        return scipy.stats.mode(a=np.array(self.preds), axis=0, nan_policy="propagate", keepdims=False)[0]
