...
class TrainingDatasetCE(Dataset):
...
class TestingDatasetCE(Dataset):
...
def get_ce_dataloader(dataset_name, data_path, positive_class_index, positive_num, unlabeled_num, true_class_prior, batch_size, pos_label):
    ...
    training_dataset = TrainingDatasetCE(images=training_data, labels=training_labels, true_labels=training_true_labels, transforms=training_transforms)
    ...
    testing_dataset = TestingDatasetCE(images=all_dataset["all_testing_data"], true_labels=all_dataset["all_testing_label"], transforms=testing_transforms)
